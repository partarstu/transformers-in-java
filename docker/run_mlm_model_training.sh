...
JAR_NAME="train-0.0.1-SNAPSHOT-shaded.jar"
RUN_COMMAND="java -XX:+UseZGC -XX:SoftMaxHeapSize=2G -XX:ZCollectionInterval=15 -XX:ZUncommitDelay=10 -Xmx3G --enable-preview -jar ${JAR_NAME}"
